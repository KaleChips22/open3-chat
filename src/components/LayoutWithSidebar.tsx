...
import { Sidebar, SidebarContent, SidebarGroup, SidebarGroupContent, SidebarGroupLabel, SidebarHeader, SidebarMenuButton, SidebarMenuItem, SidebarProvider, SidebarTrigger } from '@/components/ui/sidebar'
            ...
            <SidebarGroup className='flex flex-col mt-4 gap-1'>
              ...
              <SidebarGroupContent className='flex flex-col gap-2'>
                {chats.length > 0 ? chats.map((chat) => (
                  <SidebarMenuItem key={chat.id} className='flex flex-row items-center gap-2' onClick={() => router.push(`/chat/${chat.id}`)}>
